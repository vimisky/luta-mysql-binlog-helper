...
public class DebeziumReplicator {
    private static final Logger logger = LoggerFactory.getLogger(DebeziumReplicator.class);
...
//    private BinlogTransactionOutput binlogTransactionOutput = null;
    ...
    public DebeziumReplicator() {
    }

    public DebeziumReplicator(String taskUUID, LutaBinlogService lutaBinlogService) {
...
protected EventDeserializer createEventDeserializer() {
    ...
    public boolean startDebeziumEngine() throws IOException {
// Define the configuration for the Debezium Engine with MySQL connector...
        ...
        props.setProperty("database.port", "23308");
        props.setProperty("database.user", "datasyncer");
        props.setProperty("database.password", "sNz5ErPQClnwJEiO");
        props.setProperty("database.server.id", "20");
